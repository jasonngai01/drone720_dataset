...
model_path_um = 'model/uav20211125m.tflite'
...
def sd_callback(rec, frames, time, status):
    ...
    elif uav_prediction_um == 1: # show 0 or 1 , uav detected or not
        print('{:.3f}%       UAV from far detected'.format(top_score_um))
        
    elif uav_prediction_um == 2: # show 0 or 1 , uav detected or not
        print('{:.3f}%       Hovering UAV detected'.format(top_score_um))
    
    elif uav_prediction_um == 3: # show 0 or 1 , uav detected or not
